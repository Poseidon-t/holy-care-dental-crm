        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              <Image src="/images/logo.jpg" alt="Holy Care Dental" width={32} height={32} className="w-8 h-8" />
              <span className="font-bold font-heading text-heading text-base hidden sm:inline">Holy Care Dental</span>
            </Link>
            {breadcrumb && (
              <>
