      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Content */}
            <div>
              <p className="text-primary-600 font-bold text-sm uppercase tracking-wider mb-2">About the Doctor</p>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                Dedicated to Your<br />Dental Health
              </h2>
              <p className="text-gray-400 tamil mb-6">உங்கள் பல் ஆரோக்கியத்திற்கு அர்ப்பணிக்கப்பட்டது</p>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <strong className="text-gray-900">Dr. Pinky Vijay</strong> is a highly qualified orthodontist with an <strong className="text-gray-900">MDS in Orthodontics and Dentofacial Orthopedics</strong> (BDS, (Mum), MDS (Orthodontics)). As a specialist in braces and aligners, she brings expertise, precision, and a compassionate approach to every patient.
                </p>
                <p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                  ...
                  <p className="font-bold text-gray-900 text-sm">MDS Qualified</p>
                  <p className="text-xs text-gray-500 mt-0.5">Orthodontics specialist</p>
                </div>
                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                  <div className="text-2xl mb-1">😁</div>
                  <p className="font-bold text-gray-900 text-sm">Braces Expert</p>
                  <p className="text-xs text-gray-500 mt-0.5">Braces &amp; aligners specialist</p>
                </div>
                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                  <div className="text-2xl mb-1">🏥</div>
                  <p className="font-bold text-gray-900 text-sm">Modern Clinic</p>
                  <p className="text-xs text-gray-500 mt-0.5">Advanced equipment</p>
                </div>
                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                  <div className="text-2xl mb-1">💝</div>
                  <p className="font-bold text-gray-900 text-sm">Community Service</p>
